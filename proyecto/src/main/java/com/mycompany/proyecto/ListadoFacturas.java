...
public class ListadoFacturas extends UI{
    ...
    ArrayList<Cliente> propietariosList = new ArrayList();
    ...
    protected void init(VaadinRequest vaadinRequest) {
        ...
        for (int i = 0; i < propietariosList.size(); i++) {
            propietariosList.addItem(new ElementoSel(propietariosList.get(i).getObject_id(), propietariosList.get(i).getDni()));
        }
        // Creamos un combobox de los apartamentos
        ComboBox comboboxPropietarios = new ComboBox("Seleciona un Propietario:", comboboxPropietarios);
